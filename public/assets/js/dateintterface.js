...
(gj.widget = function () {
        ...
        initialize: function (a, b, c) {
            ...
            (d =
                "bootstrap" === b.uiLibrary
                    ...
                    ? $('<button class="btn btn-outline-secondary border-left-0" type="button">' + b.icons.rightIcon + "</button>")
                    : $(b.icons.rightIcon)),
                ...
                "bootstrap" === b.uiLibrary || "bootstrap4" === b.uiLibrary || "bootstrap5" === b.uiLibrary
                    ? "small" === b.size
    ...
    (gj.dialog.config = {
        ...
        bootstrap5: {
            style: { modal: "gj-modal", content: "modal modal-content gj-dialog-bootstrap5", header: "modal-header", headerTitle: "modal-title", headerCloseButton: "btn-close", body: "modal-body", footer: "gj-dialog-footer modal-footer" },
        },
    }),
    (gj.dialog.events = {
                ...
                0 === d.length && e.closeButtonInHeader
                    ? ((d =
                          "bootstrap5" === e.uiLibrary
                              ? $('<button type="button" data-role="close" title="' + gj.dialog.messages[e.locale].Close + '" data-bs-dismiss="modal" aria-label="Close"></button>')
                              : $('<button type="button" data-role="close" title="' + gj.dialog.messages[e.locale].Close + '"><span>×</span></button>')),
    ...
    (gj.tree.config = {
        ...
        bootstrap5: {
            style: { wrapper: "gj-unselectable gj-tree-bootstrap-5", list: "gj-list gj-list-bootstrap", item: "list-group-item", active: "active", border: "gj-tree-bootstrap-border" },
            icons: { expand: '<i class="gj-icon plus" />', collapse: '<i class="gj-icon minus" />' },
        },
    ...
    (gj.checkbox.config = {
        ...
        bootstrap5: { style: { wrapperCssClass: "gj-checkbox-bootstrap gj-checkbox-bootstrap-5" }, iconsLibrary: "materialicons" },
    ...
    (gj.datetimepicker.config = {
        ...
        bootstrap5: { style: { calendar: "gj-picker gj-picker-bootstrap datetimepicker gj-unselectable" } },
    }),
