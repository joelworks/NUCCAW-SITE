            ...
            (f.extend(a.prototype, {
                    ...
                    var a = this,
                        ...
                        c = i
                            ...
                            .map(function (e) {
                                ...
                                return e === h && (e = t === h || null === t ? 1e4 : +t), { className: n, includeIn: [], auto: !1, control: !1, never: !!n.match(/\b(dtr\-)?never\b/), priority: e };
                            }),
                        u = function (e, t) {
                            e = c[e].includeIn;
                ...
                _tabIndexes: function () {
                    ...
                    t.filter("[data-dtr-keyboard]").removeData("[data-dtr-keyboard]"),
                        ("number" == typeof i ? e.cells(null, i, { page: "current" }).nodes().to$() : f((i = "td:first-child, th:first-child" === i ? ">td:first-child, >th:first-child" : i), e.rows({ page: "current" }).nodes()))
                            ...
                            return function (i, e, t) {
                                ...
                                f.each(t, function (e, t) {
                                    ...
                                    t.hidden &&
                                        ...
                                        f("<li " + n + ' data-dtr-index="' + t.columnIndex + '" data-dt-row="' + t.rowIndex + '" data-dt-column="' + t.columnIndex + '"><span class="dtr-title">' + t.title + "</span> </li>")
                            ...
                            return (
                                ...
                                function (e, t, n) {
                                    n = f
                                        .map(n, function (e) {
                                            return (
                                                "<tr " + (e.className ? 'class="' + e.className + '"' : "") + ' data-dt-row="' + e.rowIndex + '" data-dt-column="' + e.columnIndex + '"><td>' + e.title + ":</td> <td>" + e.data + "</td></tr>"
                                            );
                                        })
                                        .join("");
